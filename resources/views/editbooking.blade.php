...
@section('content')
    	...
    	<div class="container-wrap">
            ...
            <h3 class="mb-3">Edit Appointments</h3>
          ...
          {!! Form::open(['action' => ['BookingController@update', $Booking->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
          @csrf
          <div class="form-group">
              {{Form::label('FirstName', 'FirstName')}}
              {{Form::text('FirstName', $Booking->FirstName, ['class'=> 'form-control', 'placeholder'=> 'FirstName'])}}
          </div>
          <div class="form-group">
              {{Form::label('LastName', 'LastName')}}
              {{Form::text('LastName', $Booking->LastName, ['class'=> 'form-control', 'placeholder'=> ''])}}
          </div>
          <div class="form-group">
              {{Form::label('Date', 'Date')}}
              {{Form::Date('Date', $Booking->Date, ['class'=> 'form-control', 'placeholder'=> ''])}}
          </div>
          <div class="form-group">
              {{Form::label('Time', 'Time')}}
              {{Form::text('Time', $Booking->Time, ['class'=> 'form-control', 'placeholder'=> ''])}}
          </div>
          <div class="form-group">
              {{Form::label('Phone', 'Phone')}}
              {{Form::text('Phone', $Booking->Phone, ['class'=> 'form-control', 'placeholder'=> ''])}}
          </div>
          <div class="form-group">
               {{Form::label('Message', 'Message')}}
               {{Form::textarea('Message', $Booking->Message, ['class'=> 'form-control', 'placeholder'=> ''])}}
           </div>
